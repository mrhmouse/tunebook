...
struct tunebook_error {
  enum {
    ...
    ERROR_NEED_VOICE,
    ERROR_NEED_INSTRUMENT,
    ERROR_NEED_OSCILLATOR,
    ERROR_NEED_SONG,
  } type;
 ...
 int *s_instruments, int *s_songs) {
  ...
  for (;;) {
	...
	goto error;
      ...
      if (!instrument) {
        error->type = ERROR_NEED_INSTRUMENT;
        goto error;
      }
	...
	goto error;
      ...
      if (!oscillator) {
        error->type = ERROR_NEED_OSCILLATOR;
        goto error;
      }
